    ...
    <v-overlay color="primary" :value="overlay" opacity="1">
        ...
        <v-container class="pa-6">          
            <v-form v-model="valid">
                ...
                <v-btn rounded class="mb-2" :loading="loading" :disabled="loading" large block color="green" @click="sendLogin" dark><v-icon left>mdi-login</v-icon>Entrar - v1.0.2</v-btn>          
                <RegistrarDialog />
            </v-form>
        </v-container>
    </v-card>
